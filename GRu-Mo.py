...
# 	try:
# 		for gapSize in range(1, maxgapsize + 1):
# 				# print(fastqLine[(fastq_rel_pos + gapSize ):(fastq_rel_pos + gapSize + 10)])
# 				# print(fastaLine[(fasta_rel_pos):(fasta_rel_pos + 10)])
...
# 						fastq_seq_comp = fastqLine[(fastq_rel_pos + gapSize ):(fastq_rel_pos + gapSize + 10)]
# 						fasta_seq_comp = fastaLine[(fasta_rel_pos):(fasta_rel_pos + 10)]
# 						diff_count = 0
# 						for a,b in zip(fastq_seq_comp, fasta_seq_comp):
# 							if a != b or a == "-" or b == "-":
# 								diff_count += 1
# 						if diff_count < lowest_error:
# 							print(diff_count)
# 							lowest_error = diff_count
# 							lowest_error_gap = gapSize
# 		return lowest_error_gap
#
# 	except IndexError:
# 		return False
